...
export const services = [
  {
    title: "Escalator Design & Installation",
    description:
      "Providing custom escalator designs and professional installation services tailored to meet specific building requirements.",
    icon: (
      <svg
    ...
    hoverStrokeColor: "group-hover:stroke-white",
  },
  {
    title: "Maintenance & Repair Services",
    description:
      "Comprehensive escalator maintenance and repair services to ensure optimal performance and longevity.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Upgrading older escalator systems with the latest technology to improve safety, energy efficiency, and performance.",
    icon: (
      <svg
  ...
  {
    title: "Escalator Safety & Compliance",
    description:
      "Ensuring all escalator systems are compliant with the latest safety regulations and standards, prioritizing user safety.",
    icon: (
      <svg
